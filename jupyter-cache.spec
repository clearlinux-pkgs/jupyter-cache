...
License  : MIT
Requires: jupyter-cache-bin = %{version}-%{release}
Requires: jupyter-cache-license = %{version}-%{release}
Requires: jupyter-cache-python = %{version}-%{release}
Requires: jupyter-cache-python3 = %{version}-%{release}
BuildRequires : buildreq-distutils3
BuildRequires : pypi(attrs)
BuildRequires : pypi(black)
BuildRequires : pypi(click)
BuildRequires : pypi(click_completion)
...
%package bin
Summary: bin components for the jupyter-cache package.
Group: Binaries
Requires: jupyter-cache-license = %{version}-%{release}

%description bin
bin components for the jupyter-cache package.


%package license
Summary: license components for the jupyter-cache package.
Group: Default

%description license
license components for the jupyter-cache package.


%package python
Summary: python components for the jupyter-cache package.
Group: Default
Requires: jupyter-cache-python3 = %{version}-%{release}

%description python
python components for the jupyter-cache package.


%package python3
Summary: python3 components for the jupyter-cache package.
Group: Default
...
Requires: pypi(black)
Requires: pypi(click)
Requires: pypi(click_completion)
...
%description python3
python3 components for the jupyter-cache package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637345628
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/jupyter-cache
cp %{_builddir}/jupyter-cache-0.4.3/LICENSE %{buildroot}/usr/share/package-licenses/jupyter-cache/ab5a711cce75e49bdbd08bbcb728262e30580e5d
...
/usr/share/package-licenses/jupyter-cache/ab5a711cce75e49bdbd08bbcb728262e30580e5d
